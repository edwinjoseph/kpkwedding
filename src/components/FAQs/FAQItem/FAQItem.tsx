...
const FAQItem = ({ title, content, isOpen, onClick }: FAQItemProps) => (
    <div class="relative border-t border-[#CBCBCB]">
        <button class="flex justify-between w-full items-center pt-4 md:pt-6 pb-4 md:pb-6 gap-x-2" onClick={onClick}>
            <h3 class="font-bold text-left md:text-2xl">{title}</h3>
            <div
