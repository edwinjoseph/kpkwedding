...
const Hero = () => (
    <Section>
        <Section.Container>
            <div className={`flex flex-col justify-center max-w-[1369px] mx-auto aspect-[343/540] md:aspect-[377/505] lg:aspect-[413/234] bg-[url('/assets/hero-mobile.jpg')] md:bg-[url('/assets/hero-tablet.jpg')] lg:bg-[url('/assets/hero.jpg')] bg-cover bg-top`}>
