    ...
    return (
        <Section class="mt-0 md:mt-0" ref={setRef}>
            <Section.Container isFullWidth>
                <div class={`mx-auto flex flex-col justify-center bg-[url('/assets/hero-mobile.jpg')] bg-cover bg-top h-[calc(100dvh_-_180px)] min-h-[400px] md:bg-[url('/assets/hero-tablet.jpg')] lg:bg-[url('/assets/hero.jpg')]`}>
